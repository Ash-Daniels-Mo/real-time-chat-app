...
# Private messages
@messages_bp.route("/private/<int:other_user_id>", methods=["GET"])
@jwt_required()
...
@messages_bp.route("/private/<int:other_user_id>", methods=["POST"])
@jwt_required()
...
@messages_bp.route("/private/<int:other_user_id>/<int:message_id>", methods=["DELETE"])
@jwt_required()
